...
MinIO requires Kafka version 0.10 or 0.9. Internally MinIO uses the [Shopify/sarama](https://github.com/IBM/sarama/) library and so has the same version compatibility as provided by this library.
